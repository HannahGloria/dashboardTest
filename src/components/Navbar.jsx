...
export default function Navbar() {
  return (
    <nav class="relative bg-stone-950 after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10">
    ...
    <div class="relative flex h-16 items-center justify-between">
      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        <div class="flex shrink-0 items-center">
          <img src={logo} alt="CryptoCoins by Leonor" class="h-18 w-auto" />
        </div>
        <div class="hidden sm:ml-6 sm:block m-auto">
          <div class="flex space-x-4 m-auto text-center">
            ...
            <a href="./MarketChart.jsx" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Tendencias</a>
            <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Team de Cryptocoins</a>
            <a href="./RadialPrice.jsx" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Ventas</a>
          </div>
        </div>
      </div>
      <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        ...
        <el-dropdown class="relative ml-3">
          <button class="relative flex rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
            ...
            <img src={avatar} alt="" class="size-12 rounded-full bg-gray-800 outline -outline-offset-1 outline-white/10" />
          </button>
